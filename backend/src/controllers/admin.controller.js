// import { sendOnboardingEmail } from '@/backend/utils/sendEmail.js';
const {sendOnboardingEmail} = require('../../utils/sendEmail.js')
...
exports.createUser = async (req, res) => {
  try {
    ...
    const generatedPassword = password || `${name.split(" ")[0]}123`;
