...
class AIService {
   ...
   */
  async suggestTopics(industry, company, postType) {
...
Return only the list of 5 topics separated by new lines, no numbers or bullets.`;
   ...
   */
  async generateLinkedInPost(topic, tone = "neutral", userProfile) {
...
`
   ...
   */
  async generateImagesForPost(topic, industry, count = 1) {
    const prompt = `
